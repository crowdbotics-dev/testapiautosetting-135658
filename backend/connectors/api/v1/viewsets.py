...
class Testconnectors135658ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS135658_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS135658_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS135658"
